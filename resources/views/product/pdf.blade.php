...
<body>
    <table class="table table-hover table-bordered">
        ...
        <tr>
            ...
            <td class="text-md-center">{{ $data->product_title }}</td>
            <td class="text-md-center">{{ $data->product_slug }}</td> 
            <td class="text-md-center">{{ $data->product_image }}</td>
            <td class="text-md-center">{{ $data->product_price }}</td>
        </tr>    
        @empty
        @endforelse
      </table>
